...
# Think of the game world as a stage in a play.
# The images are like costumes and props that help us understand what each character 
# (or item) is and what role they play in our game.
...
#Some objects in the game, like conveyors, can face different directions. The game loads a picture 
#(image) of these objects and then creates new pictures showing the object facing north, east, south, and west
    @staticmethod
